...
public final class BagScreen extends AbstractContainerScreen<BagMenu> {
    ...
    private static final ResourceLocation GEAR = ResourceLocation.fromNamespaceAndPath(TorchBagMod.ID, "textures/gui/gear_button.png");
    ...
    public void render(GuiGraphics g, int mx, int my, float partial) {
        // The 1.21 container screen draws its own background.
